...
const copy = {
  ...
  en: {
    ...
    metaDescription:
      "An overview of the models we are most often asked to source — ThinkPad, EliteBook, Latitude, EliteDesk and more. Specifications and what they suit. Not stock items.",
      ...
      <section className="py-14 sm:py-24">
        <Container>
          ...
          <div className="mx-auto mt-10 max-w-3xl border border-paper-edge bg-paper-dim p-6 sm:p-8">
            <h2 className="text-base font-semibold text-ink-900">{c.noShopTitle}</h2>
