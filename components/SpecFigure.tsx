...
function fingers(count: number, notchAt: number) {
  const out = [];
...
/* One memory package, with the silkscreen a real one carries. */
function chip(x: number, y: number, key: string) {
  return (
    <g key={key}>
      <rect x={x} y={y} width={74} height={58} rx={3} className="fill-[#12141c]" />
      <rect
        x={x}
        y={y}
        width={74}
        ...
        strokeWidth={1}
      />
      <rect x={x + 3} y={y + 3} width={68} height={13} rx={1} className="fill-white/[0.055]" />
...
const figures: Record<SpecKind, React.ReactNode> = {
  ...
  ram: (
    <>
      ...
      <g className="spec-part">
        <rect x={64} y={196} width={732} height={124} rx={5} className="fill-[#0d1018]" />
        <rect
          x={64}
          y={196}
          width={732}
        ...
        {[0, 1, 2, 3, 4, 5, 6, 7].map((i) => chip(96 + i * 84, 224, `c${i}`))}
  ...
  ssd: (
    <>
      ...
      <g className="spec-part">
        <rect x={150} y={214} width={600} height={96} rx={4} className="fill-[#0d1018]" />
        <rect
          x={150}
          y={214}
          width={600}
        ...
        <circle cx={742} cy={262} r={13} className="fill-none stroke-[#39415a]" strokeWidth={1.2} />
  ...
  keyboard: (
    <>
      ...
      <g className="spec-part">
        <rect x={120} y={168} width={660} height={218} rx={10} className="fill-[#0d1018]" />
        <rect
          x={120}
          y={168}
          width={660}
  ...
  battery: (
    <>
      ...
      <g className="spec-part">
        <rect x={160} y={190} width={600} height={176} rx={10} className="fill-[#0d1018]" />
        <rect
          x={160}
          y={190}
          width={600}
  ...
  tested: (
    <>
      ...
      <g className="spec-part">
        <rect x={182} y={150} width={520} height={266} rx={8} className="fill-[#0d1018]" />
        <rect
          x={182}
          y={150}
          width={520}
  ...
  warranty: (
    <>
      ...
      <g className="spec-part">
        <rect x={196} y={140} width={490} height={290} rx={8} className="fill-[#0d1018]" />
        <rect
          x={196}
          y={140}
          width={490}
